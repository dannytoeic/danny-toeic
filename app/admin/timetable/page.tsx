...
export default function AdminTimetablePage() {
  ...
  return (
    <AdminShell
      title="시간표 관리"
      description="학생 첫 화면에 보일 시간표 설명과 이미지 정보를 입력합니다."
    >
      <div
        style={{
      ...
      >
        ...
        <div style={{ marginBottom: '18px' }}>
          ...
          <input
            ...
            style={inputStyle}
            placeholder="예: /timetable/april.png"
          />
        </div>
